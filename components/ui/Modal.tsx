  ...
  return (
    ...
    >
      <div
        ...
        className="modal-content-scrollable relative max-h-[85vh] w-full max-w-md overflow-y-auto rounded-[24px] bg-white p-6 shadow-[0_8px_32px_rgba(0,0,0,0.2)] sm:p-8"
      >
        <button
          type="button"
          onClick={onClose}
